...
<html lang="en">
   <head>
      ...
      @endif
      @if(Route::is('Associers.index'))
         <link rel="stylesheet" href="{{ asset('css/associers.css') }}">
      @endif
      <!--[if lt IE 9]>
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 <li class="nav-item active">
                                    <a class="nav-link" href="service_demander.html"> Accueil  </a>
                                 </li> 
                                 @auth
                                    @if(Auth::user()->role_id == 1)
                                       <li class="nav-item">
                                          <a class="nav-link" href="{{ route('Associers.index') }}">ASSOCIERS</a>
                                       </li>
                                    @endif
                                 @endauth
                                 <li class="nav-item">
                              ...
                              @guest
                                 <div class="sign_btn"><a href="{{ route('register') }}">S'inscrir</a></div>
                              @endguest
                              @guest
                                 <div class="sign_btn"><a href="{{ route('login') }}">Connexion</a></div>
                              @endguest
                              @auth
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2022 Réaliser et maintenu par <a href="https://html.design/"> DadServices</a></p>
                     </div>
                  </div>
               </div>
            </div>
